...
class SequenceFrameworkV121Tests(unittest.TestCase):
    ...
    def test_adapter_delegates_source_validation(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            # Exactly six outgoing gaps equal 2:
            # indices 1, 2, 4, 6, 9, and 11.
            expected_left_twins = primes[gaps == 2]
            self.assertEqual(
                expected_left_twins.tolist(),
                [3, 5, 11, 17, 29, 41],
            )
            ...
            config = {
                ...
                "experiment": {"id": "EXP-TEST", "version": "1.2.2"},
                "repository": {
            ...
            result = plugin.validate_source(Path(root), required_count=6)
            self.assertEqual(result["left_twin_count"], 6)
