...
def required_release_paths():
    return ("README.md","CHANGELOG.md","ROADMAP.md","CONTRIBUTING.md","LICENSE","CITATION.cff","pyproject.toml","install.ps1","run_tests.ps1","run_demo.ps1","src/primeaiexplorer/__init__.py","src/primeaiexplorer/observatories/manager.py","src/primeaiexplorer/exporters/unified.py","src/primeaiexplorer/dashboards/html.py","src/primeaiexplorer/visualizations/svg.py","src/primeaiexplorer/publication.py")
...
def release_checks(root: Path):
    ...
    if pp.is_file(): rows.append(CheckResult("RC3 version metadata", 'version = "1.0.0rc3"' in pp.read_text(encoding="utf-8-sig"), "1.0.0rc3"))
