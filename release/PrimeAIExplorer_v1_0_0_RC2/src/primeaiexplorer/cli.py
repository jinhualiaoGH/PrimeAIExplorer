...
def cmd_doctor(args):
    ...
    return _print_checks("PrimeAIExplorer v1.0.0 RC2 Doctor",checks)
...
def cmd_release_check(args):
    ...
    return _print_checks("PrimeAIExplorer v1.0.0 RC2 Release Check",checks)
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="paiexp",
        description="PrimeAIExplorer v1.0.0 RC2 scientific AI observatory",
    )
    ...
    release_parser = sub.add_parser("release-check", help="Validate an RC2 release tree")
