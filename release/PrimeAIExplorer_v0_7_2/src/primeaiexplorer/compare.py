...
def markdown_report(comparison: dict[str, Any]) -> str:
    lines = [
        "# PrimeAIExplorer v0.7.2 Comparative Observatory",
        "",
...
def html_report(comparison: dict[str, Any]) -> str:
    ...
    return f"""<!doctype html><html><head><meta charset='utf-8'><title>PrimeAIExplorer v0.7.2</title><style>
...
</style></head><body><header><h1>PrimeAIExplorer v0.7.2</h1><p>Comparative Observatory · {comparison['analysis_count']} analyses</p></header><main>
