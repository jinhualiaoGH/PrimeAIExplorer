...
def cmd_analyze(args: argparse.Namespace) -> int:
    ...
    print("PrimeAIExplorer v0.7.2 analysis complete")
...
def _workspace_header(args: argparse.Namespace) -> None:
    ...
    print()
    print("=" * 72)
    print("PrimeAIExplorer v0.7.2 Interactive Workspace")
    print("=" * 72)
...
def cmd_compare(args: argparse.Namespace) -> int:
    ...
    (output / "manifest.json").write_text(json.dumps(manifest, indent=2) + "\n", encoding="utf-8")
    print("PrimeAIExplorer v0.7.2 comparative analysis complete")
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="paiexp",
        description="PrimeAIExplorer v0.7.2 comparative AI observatory",
    )
