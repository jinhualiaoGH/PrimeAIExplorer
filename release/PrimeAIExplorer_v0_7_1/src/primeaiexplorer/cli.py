...
def cmd_analyze(args: argparse.Namespace) -> int:
    ...
    print("PrimeAIExplorer v0.7.1 analysis complete")
...
def _workspace_header(args: argparse.Namespace) -> None:
    ...
    print()
    print("=" * 72)
    print("PrimeAIExplorer v0.7.1 Interactive Workspace")
    print("=" * 72)
...
def cmd_compare(args: argparse.Namespace) -> int:
    ...
    if args.experiment_root:
        ...
        discovered = discover_analyses(Path(args.experiment_root), exclude=output)
    ...
    (output / "manifest.json").write_text(json.dumps(manifest, indent=2) + "\n", encoding="utf-8")
    print("PrimeAIExplorer v0.7.1 comparative analysis complete")
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="paiexp",
        description="PrimeAIExplorer v0.7.1 comparative AI observatory",
    )
