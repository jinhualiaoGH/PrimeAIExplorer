...
def markdown_report(summary: dict, metadata: dict) -> str:
    lines = [
        "# PrimeAIExplorer v0.3.0 Analysis Report", "",
...
def html_report(summary: dict, metadata: dict) -> str:
    ...
    return f'''<!doctype html><html><head><meta charset="utf-8"><title>PrimeAIExplorer v0.3.0</title>
...
<body><header><h1>PrimeAIExplorer v0.3.0</h1><p>{html.escape(metadata['experiment_id'])} · {html.escape(metadata['pilot_id'])} · {html.escape(metadata['model'])}</p></header><main>
