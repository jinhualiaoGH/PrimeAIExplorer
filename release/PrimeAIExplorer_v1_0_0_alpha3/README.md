...
## v1.0.0-alpha3 Behavior Observatory

The v1 observatory API now includes `PerformanceObservatory` and `BehaviorObservatory`. The behavior module measures prediction popularity, persistence, switching, directed transitions, per-window behavior, and a standardized fingerprint without changing the inherited v0.7.3 artifact formats.
