...
class LeftTwinSequencePlugin(SequencePlugin):
    """v1.2 adapter over the verified v1.1.1 LeftTwinPlugin class API."""
    ...
    def validate_source(
        ...
        *,
        ...
        # The legacy plugin reads canonical prime_root and gap_root from config.
        # `source` is retained in the generic signature for framework parity.
    ...
    def load_values(
        ...
        *,
        ...
        # Legacy load_dataset performs canonical validation before mmap loading.
    ...
    def generate_cases_from_legacy_windows(
        ...
        *,
        ...
        """Expose exact v1.1.1 window semantics without reinterpretation."""
        legacy = self._legacy()
        return [
            {
    ...
    def is_structurally_valid(self, value: int) -> bool:
        # This operation is configuration-independent in the legacy plugin,
        # but constructing the class still requires a config. Use its verified
        # static mathematical definition directly through the legacy module.
